...
# generated_code_dir = 'generated_code_codellama_humaneval_3-2_partial.json'
#generated_code_dir = 'generated_code_beam-finetune-1119-50_humaneval_3-2.json'
generated_code_dir = 'code_5_0.json'
...
"""
    ...
    with open('code_5_0e.json','w') as file:
        json.dump(evaluated,file)